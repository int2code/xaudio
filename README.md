...
[![Build Status](https://github.com/int2code/device_communication/actions/workflows/unit_tests.yml/badge.svg?branch=master&event=push)](https://github.com/int2code/device_communication/actions/workflows/unit_tests.yml?query=event%3Apush)
