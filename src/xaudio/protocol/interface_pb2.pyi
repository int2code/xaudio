...
class StatusRespRoleA2BMaster(_message.Message):
    ...
    class A2bFault(_message.Message):
        ...
        def __init__(self, fault: _Optional[_Union[A2bState, str]] = ..., location: _Optional[_Union[A2BFaultLocation, str]] = ..., slave_with_fault: _Optional[int] = ...) -> None: ...
...
class StatusResponse(_message.Message):
    __slots__ = ("usb_audio_downstream_state", "usb_audio_upstream_state", "device_state", "config_json_state", "status_master", "status_slave")
...
class PositiveResponse(_message.Message):
    __slots__ = ("no_data_response", "status_response", "info_response", "i2c_over_distance_response", "a2b_mailbox_transfer_response", "register_dump_response")
    ...
    REGISTER_DUMP_RESPONSE_FIELD_NUMBER: _ClassVar[int]
...
class SetRegisterRequest(_message.Message):
    ...
    reg: int
    value: int
    def __init__(self, node_number: _Optional[int] = ..., reg: _Optional[int] = ..., value: _Optional[int] = ...) -> None: ...

class RequestPacket(_message.Message):
    __slots__ = ("reset_request", "a2b_discover_request", "status_request", "info_request", "set_serial_request", "i2c_over_distance_request", "a2b_mailbox_transfer_request", "register_dump_request", "set_register_request")
